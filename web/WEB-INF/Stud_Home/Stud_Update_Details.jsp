...
%>
<form action="Student_Update_Verification" method="post" >
	...
	<fieldset>
		...
		<table class="hovertable" border='0' cellspacing='0' cellpadding='0'  bgcolor="mistyrose">
			...
			<tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='mistyrose';">
				<td>DOB:</td>
				<td align="center"><input type="text" name="dob" maxlength="400" value="<%=it.next() %>" ></td>
			</tr>
			
			<tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='mistyrose';">
				<td>MOTHERS NAME:</td>
				<td align="center"><input type="text" name="mother" maxlength="400" value="<%=it.next() %>" ></td>
			</tr>
			<tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='mistyrose';">
				<td>FATHERS NAME:</td>
				<td align="center"><input type="text" name="father" maxlength="400"  value="<%=it.next() %>" ></td>
			</tr>
			<tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='mistyrose';">
			...
			<tr onmouseover="this.style.backgroundColor='#ffff66';" onmouseout="this.style.backgroundColor='mistyrose';">
				<td>EMAIL ID:</td>
				<td align="center"><input type="text" name="email" maxlength="400"  value="<%=it.next() %>" ></td>
			</tr>
		</table>
	</fieldset><br>
