<%-- 
    Document   : PR_Home
    Created on : Mar 7, 2013, 12:22:51 AM
...
<table style="height:100%;width:100%; position: absolute; top: 0; bottom: 0; left: 0; right: 0; float: left;"  border='0' cellspacing="0" cellpadding="0">
     <tr style="height: 10%;" bgcolor="yellow">
        <td>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp &nbsp&nbsp &nbsp &nbsp &nbsp&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp&nbsp &nbsp &nbsp &nbsp &nbsp&nbsp &nbsp&nbsp &nbsp &nbsp &nbsp&nbsp &nbsp <img src='header3.gif'></td>
    </tr>
    <tr style="height: 90%; ">
        <td style="width= 15%;">
		<table style="height:89%;width:15%; position: absolute; top: 11%; bottom: 0; left: 0; right: 0; float: left; " border='0' bgcolor="yellow">
		<form action="PR_Home_Process" method="POST">
			<tr><td style="width:16%;" cellspacing="0" cellpadding="0">
        ...
        <td style="height:90%;width:84%; position: absolute; top: 10%; bottom: 0; left: 16%; right: 0; float: left; " border='0'>
                           ...
                           <%
                             ...
                             <td align="center">
                                 <% 
                                    ...
                                    <a href='<%=filePath+id+"\\"+link%>' target="_blank" >click</a>
                 ...
                 <table class="hovertable" style="width:95%; position: absolute; top: 13%; bottom: 0; left: 0; right: 5%; float: left; " border="0">
                     ...
                     <form action="PR_CV_Upload" method="POST" enctype="multipart/form-data">
                     UPLOAD CV-1:
